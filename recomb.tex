...
low sequence coverage; our results show that true positives for deletions at 2x
coverage increased over six fold when both paired-end and split-read signals are
considered  (from 32 in paired-end and 39 in split-read to 245 in paired-end and
split-read).
